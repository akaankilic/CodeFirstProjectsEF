    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerSale", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerSale_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerSale_Sales_SaleId",
                        column: x => x.SaleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerSale_CustomerId",
                table: "CustomerSale",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerSale_SaleId",
                table: "CustomerSale",
                column: "SaleId");
